  ...
  const fetchProfileData = async () => {
    ...
    try {
      ...
      if (profileData.profilePictureUrl) {
        ...
        const directUrl = `https://22eb-31-142-79-237.ngrok-free.app/api/files/download/${profileData.profilePictureId}`;
                  ...
                  <Image 
                    ...
                    onError={() => {
                      ...
                      if (profile?.profilePictureId) {
                        const freshUrl = `https://22eb-31-142-79-237.ngrok-free.app/api/files/download/${profile.profilePictureId}`;
                        ...
                        if (idMatch && idMatch[1]) {
                          const freshUrl = `https://22eb-31-142-79-237.ngrok-free.app/api/files/download/${idMatch[1]}`;
